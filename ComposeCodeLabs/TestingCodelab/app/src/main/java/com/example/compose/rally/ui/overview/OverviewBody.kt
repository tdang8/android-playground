...
//    )
    ...
    val infiniteElevationAnim = rememberInfiniteTransition(label = "infinite elevation animation")
    val animatedElevation: Dp by infiniteElevationAnim.animateValue(
        initialValue = 1.dp,
        targetValue = 8.dp,
        ...
        ), label = "infinite elevation animation value"
    )
